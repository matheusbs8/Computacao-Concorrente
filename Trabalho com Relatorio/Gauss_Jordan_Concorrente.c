...
//função que será executada pelas threads e terão a função de executar a função soma_sutração em uma determinada linha
void * Zerar (void * arg) {
...
//para cumprir esse papel, ela criará as threads que executarão a função soma_sutração
